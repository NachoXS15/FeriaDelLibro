    ...
    <>
      <main>
        ...
        <section id="categories">
          ...
          <div>
            <CategoryCard bg_img='/assets/imgs/riojanos.jpg' bg_color={"#f36b77"} title1={"Autores"} title2={"Riojanos"} />
            <CategoryCard bg_img='/assets/imgs/classic.jpg' bg_color={"#ffc800"} title1={"Libros"} title2={"Clásicos"} />
            <CategoryCard bg_img='/assets/imgs/kids.jpg' bg_color={"#004b7b"} title1={"Libros"} title2={"Infantiles"} />
          </div>
        </section>
